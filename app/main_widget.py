...
from app.constants import actors, messageTypes, levels, tones, statusBarMessages
...
class MainWidget(QtWidgets.QWidget):
    def __init__(self, ai_client):
        ...
        QtCore.QTimer.singleShot(0, self.checkConnection)

    def checkConnection(self):
        try:
            self.ai_client.models.list()  # Lightweight check
    ...
    def initHeaderLayout(self):
        ...
        recipientLayout, self.recipientsCombo = self.initComboBoxLayout(
            "I am writing to a:", actors
        )
    ...
    def varnishClicked(self):
        ...
        self.worker = Worker(self.ai_client, prompt, userMessage)
